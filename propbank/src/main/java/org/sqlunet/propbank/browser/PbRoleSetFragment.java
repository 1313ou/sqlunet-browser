...
public class PbRoleSetFragment extends Fragment
{
	...
	{
		// views
		final View rootView = inflater.inflate(R.layout.fragment_pbroleset, container, false);
		final ViewGroup containerView = (ViewGroup) rootView.findViewById(R.id.data_contents);

		// root node
		final TreeNode root = TreeNode.makeRoot();
		final TreeNode queryNode = TreeFactory.addTreeItemNode(root, "RoleSet", R.drawable.propbank, getActivity()); //$NON-NLS-1$

 ...
 */
class FnLexUnitFromWordQueryCommand extends DBQueryCommand
{
	/**
	...
	public FnLexUnitFromWordQueryCommand(final SQLiteDatabase connection, final long wordId, final Character pos)
	{
		super(connection, pos != null ? FnLexUnitFromWordQueryCommand.QUERYWITHPOS : FnLexUnitFromWordQueryCommand.QUERY);
		setParams(wordId, FnLexUnitFromWordQueryCommand.mapPos(pos));
	}

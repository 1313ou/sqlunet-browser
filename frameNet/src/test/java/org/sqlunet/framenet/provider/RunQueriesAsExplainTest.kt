...
class RunQueriesAsExplainTest {
    ...
    fun runQueries() {
        ...
        val standalone = System.getenv()["standAlone"] // System.getProperty("db")
        FnFlags.standAlone = standalone.toBoolean()
        println(db)
        println("${FnFlags.standAlone}")
    ...
    private fun uriToCode(providerUri: String): Int {
        return when (providerUri) {
            FrameNetContract.LexUnits.URI1 -> FrameNetControl.LEXUNIT1
            ...
            FrameNetContract.Frames.URI1 -> FrameNetControl.FRAME1
            ...
            FrameNetContract.Sentences.URI1 -> FrameNetControl.SENTENCE1
            FrameNetContract.Sentences.URI -> FrameNetControl.SENTENCES
            FrameNetContract.AnnoSets.URI1 -> FrameNetControl.ANNOSET1

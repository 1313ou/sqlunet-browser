...
private val protoSrcDir = File(project.projectDir, "/src/proto")
private val generatedSrcDir = project.layout.buildDirectory.dir("generated/source/queries").get()
...
querybuilder_args {
    ...
    q = "Q"
    qv = "QV"
    qPackage = "org.sqlunet.xnet.provider"
    instantiateDest = "org.sqlunet.xnet.sql"
}

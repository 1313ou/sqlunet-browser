...
public class XSqlUNetProvider extends SqlUNetProvider
{
	...
	private String makeQuery(final String table1, final String table2, final String[] tableProjection0, final String[] unionProjection0, final String[] projection0, final String selection0, final String[] groupBys0, final String sortOrder0,
			final String tag0)
	{

...
import org.sqlunet.bnc.provider.Expected.expected

class RunQueriesFactoryTest {

    private val codes = intArrayOf(BNCControl.BNC, BNCControl.WORDS_BNC)
    ...
    private fun check(code: Int, r1: BNCControl.Result?, r2: BNCControl.Result?) {
    ...
    companion object {
        ...
        fun queryProvider(code: Int, uriLast: String?, projection0: Array<String>?, selection0: String?, selectionArgs0: Array<String>?): BNCControl.Result? {
            return queryProviderMain(code, uriLast, projection0, selection0, selectionArgs0)
        }

        private fun queryProviderMain(code: Int, @Suppress("UNUSED_PARAMETER") uriLast: String?, projection0: Array<String>?, selection0: String?, selectionArgs0: Array<String>?): BNCControl.Result? {

...
public class DownloadPreferenceFragment extends PreferenceFragmentCompat
{
	...
	public void onCreatePreferences(Bundle savedInstanceState, String rootKey)
	{
		...
		final Preference modelDirPreference = findPreference(Settings.PREF_MODEL_DIR);
		assert modelDirPreference != null;
		modelDirPreference.setSummaryProvider(DEVICE_STRING_SUMMARY_PROVIDER);
	}
}

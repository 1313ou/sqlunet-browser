...
{
	static public final String AUTHORITY = "org.sqlunet.wordnet.provider";
	// A L I A S E S
	...
	static public final class CasedWords
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + CasedWords.TABLE;
	...
	static public final class Senses
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Senses.TABLE;
		static public final String WORDID = "wordid";
	...
	static public final class Synsets
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Synsets.TABLE;
		static public final String SYNSETID = "synsetid";
	...
	static public final class SemLinks
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + SemLinks.TABLE;
	...
	static public final class LexLinks
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LexLinks.TABLE;
	...
	static public final class LinkTypes
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LinkTypes.TABLE;
		static public final String LINKID = "linkid";
	...
	static public final class PosTypes
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + PosTypes.TABLE;
		static public final String POS = "pos";
	...
	static public final class AdjPositionTypes
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + AdjPositionTypes.TABLE;
	...
	static public final class LexDomains
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LexDomains.TABLE;
		static public final String LEXDOMAINID = "lexdomainid";
	...
	static public final class Samples
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Samples.TABLE;
		static public final String SYNSETID = "synsetid";
	...
	static public final class Words_Senses_Synsets
	{
		...
		// static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Words_Senses_Synsets.TABLE;
	...
	static public final class Words_Senses_CasedWords_Synsets
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Words_Senses_CasedWords_Synsets.TABLE;
	...
	static public final class Senses_Synsets_PosTypes_LexDomains
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Senses_Synsets_PosTypes_LexDomains.TABLE;
	...
	static public final class Synsets_PosTypes_LexDomains
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Synsets_PosTypes_LexDomains.TABLE;
		static public final String SYNSETID = "synsetid";
	...
	static public final class SemLinks_Synsets
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + SemLinks_Synsets.TABLE;
	...
	static public final class SemLinks_Synsets_X
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + SemLinks_Synsets_X.TABLE;
	...
	static public final class SemLinks_Synsets_Words_X
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + SemLinks_Synsets_Words_X.TABLE_BY_SYNSET;
	...
	static public final class LexLinks_Senses
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LexLinks_Senses.TABLE;
	...
	static public final class LexLinks_Senses_X
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LexLinks_Senses_X.TABLE;
	...
	static public final class LexLinks_Senses_Words_X
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + LexLinks_Senses_Words_X.TABLE_BY_SYNSET;
		static public final String SYNSET1ID = "synset1id";
		static public final String SYNSET2ID = "synset2id";
		static public final String MEMBERS2 = "members";
	...
	static public final class VerbFrameMaps_VerbFrames
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + VerbFrameMaps_VerbFrames.TABLE;
		static public final String SYNSETID = "synsetid";
		static public final String WORDID = "wordid";
	...
	static public final class VerbFrameSentenceMaps_VerbFrameSentences
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + VerbFrameSentenceMaps_VerbFrameSentences.TABLE;
		static public final String SYNSETID = "synsetid";
		static public final String WORDID = "wordid";
	...
	static public final class AdjPositions_AdjPositionTypes
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + AdjPositions_AdjPositionTypes.TABLE;
		static public final String SYNSETID = "synsetid";
		static public final String WORDID = "wordid";
		static public final String POSITION = "position";
		static public final String POSITIONNAME = "positionname";
	...
	static public final class MorphMaps_Morphs
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + MorphMaps_Morphs.TABLE;
		static public final String WORDID = "wordid";
	...
	static public final class Dict
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Dict.TABLE;
		// words LEFT JOIN senses LEFT JOIN casedwords LEFT JOIN synsets
	}
	...
	static public final class Lookup_Words
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Lookup_Words.TABLE;
		static public final String WORDID = "wordid";
		static public final String LEMMA = "lemma";
	}
	...
	static public final class Lookup_Definitions
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Lookup_Definitions.TABLE;
		static public final String SYNSETID = "synsetid";
		static public final String DEFINITION = "definition";
	}
	...
	static public final class Lookup_Samples
	{
		...
		static public final String CONTENT_URI = BaseProvider.SCHEME + WordNetContract.AUTHORITY + '/' + Lookup_Samples.TABLE;
		static public final String SYNSETID = "synsetid";
		static public final String SAMPLE = "sample";
	}

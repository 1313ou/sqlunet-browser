...
object QueriesNew {
    ...
    @JvmStatic
    fun queryNew(code: Int, uriLast: String, projection0: Array<String>, selection0: String?, selectionArgs0: Array<String>?, @Suppress("unused") sortOrder0: String?, subqueryFactory: WordNetControl.Factory): WordNetControl.Result? {
        val table: String

...
public class VerbNetFragment extends Fragment
{
	...
	{
		// views
		final View rootView = inflater.inflate(R.layout.fragment_verbnet, container, false);
		final ViewGroup containerView = (ViewGroup) rootView.findViewById(R.id.data_contents);

		// root node
		final TreeNode root = TreeNode.makeRoot();
		final TreeNode queryNode = TreeFactory.addTreeItemNode(root, "VerbNet", R.drawable.verbnet, getActivity()); //$NON-NLS-1$

...
class BrowseFragment : BaseSearchFragment() {
    ...
    init {
        ...
        menuIds = listOf(R.menu.database, CommonR.menu.capture)
    ...
    override val initialSelection: Int = SnSettings.Selector.getPref(AppContext.context).ordinal

    // M E N U

    override fun fragmentMenuDispatch(item: MenuItem): Boolean {
    ...
    private fun makeOverviewFragment(): Fragment {
        ...
        // type
        val selectorType = SnSettings.getXSelectorPref(AppContext.context)
    ...
    private fun makeSelectorIntent(): Intent {
        ...
        val intent: Intent = when (selectorMode) {
            ...
            SelectorViewMode.WEB -> Intent(AppContext.context, WebActivity::class.java)
        }

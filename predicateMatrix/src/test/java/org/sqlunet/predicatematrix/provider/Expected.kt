...
object Expected {
    ...
    fun expected(code: Int, @Suppress("UNUSED_PARAMETER") uriLast: String, projection0: Array<String>, selection0: String?, selectionArgs0: Array<String>?): PredicateMatrixControl.Result? {
        val table: String

...
public class IabHelper
{
	...
	public void enableDebugLogging(@SuppressWarnings("SameParameterValue") boolean enable)
	{
		checkNotDisposed();
		mDebugLog = enable;
	}
	...
	@SuppressWarnings("unused")
	public void launchPurchaseFlow(@NonNull AppCompatActivity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) throws IabAsyncInProgressException
	{
		launchPurchaseFlow(act, sku, requestCode, listener, "");
	}

	public void launchPurchaseFlow(@NonNull AppCompatActivity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) throws IabAsyncInProgressException
	{
		launchPurchaseFlow(act, sku, ITEM_TYPE_INAPP, null, requestCode, listener, extraData);
	}

	@SuppressWarnings("unused")
	public void launchSubscriptionPurchaseFlow(@NonNull AppCompatActivity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) throws IabAsyncInProgressException
	{
		launchSubscriptionPurchaseFlow(act, sku, requestCode, listener, "");
	}

	private void launchSubscriptionPurchaseFlow(@NonNull AppCompatActivity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, @SuppressWarnings("SameParameterValue") String extraData) throws IabAsyncInProgressException
	{
	 ...
	 */
	private void launchPurchaseFlow(@NonNull AppCompatActivity act, String sku, @NonNull String itemType, @Nullable @SuppressWarnings("SameParameterValue") List<String> oldSkus, int requestCode, @Nullable OnIabPurchaseFinishedListener listener, String extraData) throws IabAsyncInProgressException
	{
		checkNotDisposed();
	 ...
	 */
	@NonNull
	private Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus, List<String> moreSubsSkus) throws IabException
	{
		checkNotDisposed();
	 ...
	 */
	private void queryInventoryAsync(@SuppressWarnings("SameParameterValue") final boolean querySkuDetails, @SuppressWarnings("SameParameterValue") final List<String> moreItemSkus, @SuppressWarnings("SameParameterValue") final List<String> moreSubsSkus, @Nullable final QueryInventoryFinishedListener listener) throws IabAsyncInProgressException
	{
	 ...
	 */
	private void consume(@NonNull Purchase itemInfo) throws IabException
	{
		checkNotDisposed();
	 ...
	 */
	@SuppressWarnings("unused")
	public void consumeAsync(@NonNull List<Purchase> purchases, OnConsumeMultiFinishedListener listener) throws IabAsyncInProgressException
	{
		checkNotDisposed();
		checkSetupDone("consume");
	...
	private int getResponseCodeFromBundle(@NonNull Bundle b)
	{
	...
	// Workaround to bug where sometimes response codes come as Long instead of Integer
	private int getResponseCodeFromIntent(@NonNull Intent i)
	{
	...
	private void flagStartAsync(String operation) throws IabAsyncInProgressException
	{
		synchronized (mAsyncInProgressLock)
		{
			if (mAsyncInProgress)
			{
				throw new IabAsyncInProgressException("Can't start async operation (" + operation + ") because another async operation (" + mAsyncOperation + ") is in progress.");
			}
	...
	private void consumeAsyncInternal(@NonNull final List<Purchase> purchases, @Nullable final OnConsumeFinishedListener singleListener, @Nullable final OnConsumeMultiFinishedListener multiListener) throws IabAsyncInProgressException
	{
		final Handler handler = new Handler();
